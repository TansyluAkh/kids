...
class SoundGameResultScreen extends StatelessWidget {
  final String tatcategory;
  final result;
  final qnum;


  const SoundGameResultScreen({Key key, this.tatcategory, this.qnum, this.result}) : super(key: key);
